...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('accounts')->insert([
            ...
            ['Id_Account' => 5,
            'Email_Account' => 'dborto@web4all.com',
            'Password_Account' => bcrypt('000000'),
            ...
            ['Id_Account' => 6,
            'Email_Account' => 'maxime@web4all.com',
            'Password_Account' => bcrypt('000000'),
            ...
            ['Id_Account' => 7,
            'Email_Account' => 'steven@web4all.com',
            'Password_Account' => bcrypt('000000'),
            'First_name_Account' => 'Steven',
            'Last_name_Account' => 'Viera',
            'Birth_date_Account' => now()->subYears(63)->toDateString(),
            'Id_Role' => 2],


            ['Id_Account' => 8,
            'Email_Account' => 'thomas@web4ll.com',
            'Password_Account' => bcrypt('000000'),
            'First_name_Account' => 'Thomas',
            'Last_name_Account' => 'Palisse',
            'Birth_date_Account' => now()->subYears(13)->toDateString(),
            'Id_Role' => 2],
            ['Id_Account' => 9,
            'Email_Account' => 'chris@web4all.com',
            'Password_Account' => bcrypt('000000'),
            ...
            'Id_Role' => 2],
            ['Id_Account' => 10,
            'Email_Account' => 'argan@web4all.com',
            'Password_Account' => bcrypt('000000'),
            'First_name_Account' => 'Argan',
            'Last_name_Account' => 'LeTomic',
            'Birth_date_Account' => now()->subYears(35)->toDateString(),
            'Id_Role' => 2],
            ['Id_Account' => 11,
            'Email_Account' => 'raphael@web4all.com',
            'Password_Account' => bcrypt('000000'),
            'First_name_Account' => 'Raphael',
            'Last_name_Account' => 'Guerro',
            'Birth_date_Account' => now()->subYears(17)->toDateString(),
            'Id_Role' => 2],
            ['Id_Account' => 12,
            'Email_Account' => 'yren@web4all.com',
            'Password_Account' => bcrypt('000000'),
        ...
        DB::table('offers')->insert([
            ...
            'End_date_Offer' => now()->addDays(30)->toDateString(),
            'Id_Category' => 1,
            'Id_Status' => 1,
            'Id_Account' => 2,
            'Id_Company' => 1,
