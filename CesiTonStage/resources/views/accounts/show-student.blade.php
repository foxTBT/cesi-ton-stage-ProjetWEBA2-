...
@foreach ($students as $student)
    <div class="max-w-100 mx-auto bg-gray-100 shadow-lg rounded-lg p-6 border mb-4">
        ...
        <div class="flex flex-row place-content-evenly mt-4 font-bold">
            ...
            <a href="{{ route('accounts.edit', $student->Id_Account) }}" class="text-yellow-500 px-4 py-2 rounded h-min border-yellow-500 border-2 hover:border-blue-500 hover:bg-blue-300 hover:text-black">Mettre à jour</a>
