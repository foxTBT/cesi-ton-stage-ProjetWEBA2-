...
@section('content')
    ...
    <form action="{{ route('companies.store') }}" method="POST">
        ...
        <div class="max-w-lg mx-auto bg-white shadow-lg rounded-lg border p-6 mt-4 mb-4">
            ...
            <h2 class="shadow-lg rounded-lg bg-yellow-500 mx-auto w-fit text-xl font-semibold pt-2 pl-12 pr-12 pb-2 mb-6">
            ...
            <ul class="space-y-3 mx-auto w-fit">
                ...
                <li>
                    ...
                    <input value="{{ old('Phone_number_Company') }}" type="text" id="Phone_number_Company"
                        name="Phone_number_Company"
                        class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required>
                </li>

                <li>
                    <label for="Description_Company" class="block text-gray-700"><strong>Description :</strong></label>
                    <input value="{{ old('Description_Company') }}" type="text" id="Description_Company"
                ...
                <li>
                    ...
                    <input value="{{ old('Siret_number_Company') }}" type="text" id="Siret_number_Company"
                        name="Siret_number_Company"
                        class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required>
                </li>

                <li>
                    <label for="Logo_link_Company" class="block text-gray-700"><strong>Chemin Logo :</strong></label>
                    <input value="{{ old('Logo_link_Company') }}" type="text" id="Logo_link_Company"
                        name="Logo_link_Company"
                        class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required>
                </li>

                <li>
                    {{-- <label for="Id_City" class="block text-gray-700"><strong>Ville :</strong></label>
                    <input value="{{ old('Id_City') }}" type="text" id="Id_City" name="Id_City"
                        class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required> --}}
                ...
                <li class="mx-auto w-fit">
                    <button type="submit"
                        class="bg-white text-yellow-500 px-4 py-2 rounded h-min border-yellow-500 border-2 hover:border-green-500 hover:bg-green-300 hover:text-black"><strong>Ajouter</strong></button>
                </li>
            </ul>
        </div>
