    ...
    <div class="bg-white shadow-lg rounded-lg border p-6 mt-4 mb-4">
        ...
        <ul class="space-y-3">
            ...
            <li>
                ...
                <input type="text" id="Email_Company" name="Email_Company" value="{{ $company->Email_Company }}" class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required>
            </li>

            <li>
                <label for="Phone_number_Company" class="block text-gray-700"><strong>Téléphone :</strong></label>
                <input type="text" id="Phone_number_Company" name="Phone_number_Company" value="{{ $company->Phone_number_Company }}" class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required>
            </li>

            <li>
                <label for="Description_Company" class="block text-gray-700"><strong>Description :</strong></label>
                <input type="text" id="Description_Company" name="Description_Company" value="{{ $company->Description_Company }}" class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required>
            </li>

            <li>
                <label for="Siret_number_Company" class="block text-gray-700"><strong>SIRET :</strong></label>
                <input type="text" id="Siret_number_Company" name="Siret_number_Company" value="{{ $company->Siret_number_Company }}" class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required>
            </li>

            <li>
                <label for="Logo_link_Company" class="block text-gray-700"><strong>Chemin Logo :</strong></label>
                <input type="text" id="Logo_link_Company" name="Logo_link_Company" value="{{ $company->Logo_link_Company }}" class="border-gray-700 w-full px-4 py-2 border rounded-lg hover:bg-yellow-50" required>
            </li>
